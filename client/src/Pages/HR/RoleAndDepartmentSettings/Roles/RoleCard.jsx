...
const RoleCard = ({ index, role, onEditRole, handleDeleteRole }) => {
  ...
  // Predefined roles that shouldn't have edit or delete options
  const nonEditableRoles = ["Human Resource", "Accountant"];
  ...
  return (
    ...
    >
      ...
      <div className="ml-4 flex-1">
        ...
        <p className="text-xs text-gray-500">Created by: {role.createdBy}</p>
      </div>

      {/* Hide Edit & Delete for predefined roles */}
      ...
      <DialogBox
        ...
        discription="Are you sure you want to delete this role permanently?"
