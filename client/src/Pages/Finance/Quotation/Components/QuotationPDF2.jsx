...
const QuotationCard2 = () => {
  ...
  const subtotal = invoiceData.quotationItems.reduce(
      ...
      <div ref={printRef} className="w-full p-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="text-normal">
              <p className="text-normal font-semibold">{companyInfo.name}</p>
          ...
          <div>
            ...
            <div className="text-medium">
              ...
              <p className="font-semibold">{invoiceData.to || ""}</p>
        ...
        <div className="mb-8 overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {invoiceData.quotationItems.map((item, index) => (
