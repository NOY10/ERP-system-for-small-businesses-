...
export default function NewInvoice() {
  ...
  const handleSave = async () => {
    const invoiceItems = tableData.map((row) => ({
  ...
  return (
    <main className="p-5">
      <div className="flex items-center justify-between px-4 bg-white shadow rounded-lg h-[70px] mb-4">
        <span className="text-gray-700 font-semibold text-lg">New Invoice</span>
      ...
      {showToast && (
        <Toast
          ...
          message="The Invoice was added to your Invoice Table."
          duration={3000}
