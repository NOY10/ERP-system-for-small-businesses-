  ...
  return (
    <div className="bg-white flex-1 rounded-lg shadow-md border border-gray-200">
      <div className="flex items-center w-full p-4 border-b bg-white rounded-t-lg relative gap-x-1 md:gap-x-2 md:p-4 z-10">
        ...
        <Tooltip
          tooltip="Current and overdue amount that you're yet to pay to vendors"
          position="bottom"
        >
      ...
      {/* <div ref={dropdownRef} className="relative cursor-pointer">
          ...
          {isOpen && (
            <div className="absolute top-full p-2 right-[10px] mt-2 w-48 bg-white shadow-lg rounded-xl z-10 border border-gray-200">
              <div
      ...
      <div className="flex items-center py-2">
        ...
        <div className="flex flex-col gap-y-4 justify-center w-full px-4">
          <button
            onClick={() => handleNavigation("/NewQuotation")}
            className="flex items-center gap-x-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-600 shadow-md w-[130px] ml-auto"
          >
            <FaPlusCircle className="text-white" />
            <p className="text-sm">New Bill</p>
          </button>
          <div className="grid grid-cols-[60%_40%] gap-x-4 mt-2">
            ...
            <div className="text-sm text-gray-600 text-left break-words">
              {data.bills.current + data.bills.overdue}
            </div>
          </div>
        </div>
      </div>
